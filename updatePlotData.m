function updatePlotData(app, runNumber, result)
    ...
    if app.CheckBox.Value
        ...
        app.var1plot = plot(app.UIAxes4,var1norm,'color',[0.5 0.5 0.5]);       % Plot Track in white.
    else
    ...
    if app.CheckBox_2.Value
        ...
        app.var2plot = plot(app.UIAxes4,var2norm,'r');       % Plot Track in white.
    else
        hold(app.UIAxes4,'off');
        delete(app.var2plot);
        hold(app.UIAxes4,'on');
    ...
    if app.CheckBox_3.Value
        ...
        app.var3plot = plot(app.UIAxes4,var3norm,'g');       % Plot Track in white.
    else
        hold(app.UIAxes4,'off');
        delete(app.var3plot);
        hold(app.UIAxes4,'on');
    ...
    if app.CheckBox_4.Value
        ...
        app.var4plot = plot(app.UIAxes4,var4norm,'c');       % Plot Track in white.
    else
        hold(app.UIAxes4,'off');
        delete(app.var4plot);
        hold(app.UIAxes4,'on');
    ...
    if app.CheckBox_5.Value
        ...
        app.var5plot = plot(app.UIAxes4,var5norm,'m');       % Plot Track in white.
    else
        hold(app.UIAxes4,'off');
        delete(app.var5plot);
        hold(app.UIAxes4,'on');
    ...
    if app.CheckBox_6.Value
        ...
        app.var6plot = plot(app.UIAxes4,var6norm,'y');       % Plot Track in white.
    else
        hold(app.UIAxes4,'off');
        delete(app.var6plot);
        hold(app.UIAxes4,'on');
