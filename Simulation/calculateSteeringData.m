...
function [delta, beta, psi1, alpha_f, alpha_r, alpha_fr, alpha_fl, alpha_rr, alpha_rl, delta_fl, delta_fr, delta_sw, ackermann, ackermannPercent] = calculateSteeringData(wheelbase, R, lr, lf, vV, FWZ_fl, FWZ_rl, FWZ_fr, FWZ_rr, track_f)
