function Vehiclesim_Endurance_GUI_Version(setupFile, trackID, disciplineID, sensitivityID, minValue, stepSize, numSteps, sensitivityID2, minValue2, stepSize2, logCellData)
        ...
        for steps2 = 1:numSteps2
            ...
            if sensitivityID2 ~= 0 
                switch sensitivityID2
                    ...
                    case 15
                        n_max = minValue2 + stepSize2*(steps2-1);
                    case 16
