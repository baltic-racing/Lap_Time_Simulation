function Vehiclesim_Endurance_GUI_Version(setupFile, ~, trackID, disciplineID, sensitivityID, minValue, stepSize, numSteps, processDataButtonHandle, textAreaHandle, sensitivityID2, minValue2, stepSize2, logCellData, Debug)
    
    
     %% Laptime simulation
%     clear all; clc; close all;
    
    setup = load(setupFile, '-mat');
