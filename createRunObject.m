...
function createRunObject(app, saveFile, saveID)
    ...
    saveFileData = {'A_Akkuzelle' saveFile.A_Akkuzelle(1:end-1,runID); 'DRS_status' saveFile.DRS_status(1:end-1,runID);...
        ...
        'x-Coordinate' saveFile.Track(1:end-1,1); 'y-Coordinate' saveFile.Track(1:end-1,2); 'z-Coordinate' saveFile.Track(1:end-1,3); 'Distance' saveFile.Track(1:end-1,4);'Corner Radius' saveFile.Track(1:end-1,5)};
